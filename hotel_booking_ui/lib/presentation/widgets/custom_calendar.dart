...
class _CustomCalendarViewState extends State<CustomCalendarView> {
      ...
      child: Column(
        children: <Widget>[
          ...
          Padding(
            ...
            child: Row(
              children: getDaysNameUI(theme: theme),
            ),
          ),
          Padding(
            padding: const EdgeInsets.only(right: 8, left: 8),
            child: Column(
              children: getDaysNoUI(theme: theme),
            ),
          ),
        ],
      ),
  ...
  List<Widget> getDaysNameUI({required ThemeData theme}) {
  ...
  List<Widget> getDaysNoUI({required ThemeData theme}) {
